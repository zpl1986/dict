...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static byte[] decryptBySymmetricKey(byte[] encryptedData, SecretKey secret)
            throws Exception {
    	 //工厂模式获取Cipher实例 密码器
    	 Cipher cp=Cipher.getInstance("DESede");
    	 //初始化cipher ENCRYPT_MODE表示加密DECRYPT_MODE解密  后面一个参数是密钥
    	 ...
    	 byte[] miby=cp.doFinal(encryptedData);
    	 return miby;
    }
    
    public static void main(String[] args) throws Exception {
    	SecretKey secret = getSymmetricKey();
    	String str = "chtongkeji2017";
    	byte[] data = str.getBytes("UTF-8");
    	String mi = Base64.encode(encryptBySymmetricKey(data, secret));
    	System.out.println(mi);
    	byte[] ming_b = decryptBySymmetricKey(Base64.decode(mi), secret);
    	String ming_1=new String(ming_b,"utf-8");
    	System.out.println(ming_1);
    }
